        ...
        <div className=' h-screen w-full fixed top-0 left-0'>
            <div className='border-4 border-in-white rounded-xl md:w-1/2 w-full h-[60vh] md:mx-0 z-40 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                <div className='flex flex-row viewDatas-center justify-between mt-5 mb-20 px-10'>
                    ...
                    <button className='text-in-green text-2xl font-bold' title='Close modal' onClick={() => setShowModal(false)}> x </button>
                </div>
                ...
                <div className='px-10'>
                    ...
                    <span className='text-in-white'>{normalizeDate(viewData.creationDate)}</span>
                    ...
                    <div className='flex viewDatas-start'>
                        ...
                        <div className='ml-10'>
                            <p className='text-gray-400 mb-1 text-xs mt-5'> Return ({normalizeDate(viewData.creationDate) + ' - today'}) </p>
