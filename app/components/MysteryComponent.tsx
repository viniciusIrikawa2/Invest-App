...
const MysteryComponent = () => {
  return (
    <div className='w-[50px] h-[50px] bg-green-400 border-4 border-green-300 rounded-full flex items-center justify-center fixed bottom-10 right-10 cursor-pointer animate-pulse'>
        <Link target='_blank' 
